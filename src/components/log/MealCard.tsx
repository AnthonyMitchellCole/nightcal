          ...
          <CardHeader className="pb-3 pt-4 cursor-pointer hover:bg-surface-hover transition-colors duration-200">
            <CardTitle>
              ...
              <div className="flex items-center gap-1.5 text-xs flex-nowrap">
                <span className="font-semibold text-warning bg-warning/15 px-1.5 py-0.5 rounded whitespace-nowrap">
                  F: {meal.totals.fat}g <span className="opacity-75">({mealFatPercentage}%)</span>
                </span>
                <span className="font-semibold text-info bg-info/15 px-1.5 py-0.5 rounded whitespace-nowrap">
                  C: {meal.totals.carbs}g <span className="opacity-75">({mealCarbPercentage}%)</span>
                </span>
                <span className="font-semibold text-success bg-success/15 px-1.5 py-0.5 rounded whitespace-nowrap">
